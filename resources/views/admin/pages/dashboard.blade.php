                        ...
                        <div class="col-auto">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <button class="dropdown-item" type="button">Import Card</button>
                                    </li>
                                    <li>
                        ...
                        <div class="tab-pane" id="chart-tab-profile" role="tabpanel"
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <span class="text-white d-block f-34 f-w-500 my-2">
                                        $29961 <i
                                            class="ti ti-arrow-down-right-circle opacity-50"></i>
                                    </span>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-2">
                            <h4 class="text-white mb-1">
                                $203k <i class="ti ti-arrow-up-right-circle opacity-50"></i>
                            </h4>
            ...
            <div class="card dashnum-card dashnum-card-small overflow-hidden">
                ...
                <div class="card-body p-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-2">
                            <h4 class="mb-1">
                                $550K <i class="ti ti-arrow-up-right-circle opacity-50"></i>
                            </h4>
